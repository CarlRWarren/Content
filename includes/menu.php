    ...
    if($num_results > 0) {
        ...
        echo "<div id='menu-btn' class='dropdown no-color'>";
            ...
            echo "<div class='dropdown-content'>";
                echo "<form action='' method='post'><input type='hidden' name='style' value='1'></input><input class='themeBtn' type='submit' value='Theme 1'></input></form>";
                echo "<form action='' method='post'><input type='hidden' name='style' value='2'></input><input class='themeBtn' type='submit' value='Theme 2'></input></form>";
                echo "<form action='' method='post'><input type='hidden' name='style' value='3'></input><input class='themeBtn' type='submit' value='Theme 3'></input></form>";
            echo "</div>";
        echo "</div>";
    }
